...
export const LevelGauge = ({vesselId, data, styles, className}: LevelGaugeProps) => {
  const fillScale = scaleLinear()
    .domain([data.minLevel, data.maxLevel])
    .range([93, 7])

  return (
    <StyledSvg className={className} width='75' height='100' viewBox='0 0 75 100'>
      <rect
        x='2.5'
        y='2.5'
        height='95'
